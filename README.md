# 🎥 SentimentDIksha AI – YouTube Comment Sentiment Analysis
📌 Overview

SentimentDIksha AI is a full-stack web app that analyzes YouTube comments and classifies them as Positive, Neutral, or Negative.
